...
######CONFIRM WHETHER THIS COUNT AS ANALYSIS #######
...
analysis_rowan_data <- data.frame(
  Year = rowan_merged_data$Year,
  UnemploymentRate = rowan_merged_data$`37159`,
  Retirements = your_data_column_for_retirements
)

...
#Map of two layers: one is tract boundaries, the other is plants across tracts
...
mapview(Robeson_tracts, col.regions='pink', layer.name = 'Robeson County Tracts, NC') + 
 mapview(tract_plants_Robeson,
          layer.name = 'Plants Within Each Tract',
          alpha=.5)

#Table of plant data with the tract that corresponds to each plant
intersect_plants_tracts <- st_intersection(plant_gen_sf, tracts_EJI_sf_select)

#Exporting to CSV:
#write.csv(intersect_plants_tracts,'Data/Processed/EBM_Processed.csv', row.names=FALSE)
```

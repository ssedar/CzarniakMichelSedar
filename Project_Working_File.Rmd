...
```{r Figure10,fig.cap="Figure 10: Total CO2 Emissions in 2021 across North Carolina Power Plants."}
...
mapview(tracts_containing_plants, 
            col.regions='snow', 
...
```{r Figure19,fig.cap="Mapping Asthma Prevalence Across Tracts", echo=FALSE}
...
```{r Figure20,fig.cap="Relationship of median household income ($) on coal generation (MWh) in 2021 by county.", warning=TRUE}
...
```{r Figure21,fig.cap="Relationship of median household income ($) on solar generation (MWh) in 2021 by county.", echo = FALSE}
#Visualize relationship

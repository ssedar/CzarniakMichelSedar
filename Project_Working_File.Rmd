...
```{r Table9, caption="Number of historical power plant retirements per county based on 2020 eGRID dataset",echo=FALSE, warning=FALSE, error=FALSE}
...
```{r Table6,caption="Linear Regression Results - SVI and Total Generation", echo=FALSE}

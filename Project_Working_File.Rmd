...
is.Date(processed_data$GENYRONL) # not a date
processed_data$GENYRONL <- as.Date(processed_data$GENYRONL,
                                   format = "%Y")
is.Date(processed_data$GENYRONL) # changed to date

is.Date(processed_data$GENYRRET ) # not a date
processed_data$GENYRRET <- as.Date(processed_data$GENYRRET,
                                   format = "%Y")
is.Date(processed_data$GENYRRET) # changed to date

...
#Create maps of power plants
gens_counties_map <-ggplot()+geom_sf(data=counties_sf)+geom_sf(data=plant_gen_sf) + 
  scale_fill_gradient(low="yellow", high="darkgreen")
gen_locations<-mapview(plant_gen_sf)+mapview(counties_sf)
